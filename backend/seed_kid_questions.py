...
QUESTIONS = [
    ...
    {"q": "¿Cómo se llama el protagonista de The Legend of Zelda?", "o": ["Zelda", "Ganon", "Link", "Epona"], "c": 2},
    {"q": "¿En qué juego se gastan 'V-Bucks'?", "o": ["Roblox", "Minecraft", "Apex Legends", "Fortnite"], "c": 3},
    ...
    {"q": "¿Qué consola lanzó Nintendo en 2017?", "o": ["Wii U", "3DS XL", "Nintendo Switch", "GameBoy Color"], "c": 2},
    ...
    {"q": "¿Cuántas películas tiene la saga principal de Star Wars?", "o": ["6", "7", "9", "12"], "c": 2},
    ...
    {"q": "¿Cuántas patas tiene una araña?", "o": ["4", "6", "8", "10"], "c": 2},
    ...
    {"q": "¿En qué país nació Lionel Messi?", "o": ["Uruguay", "Brasil", "España", "Argentina"], "c": 3},
